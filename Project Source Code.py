...
#Rules for Checking the strength of the password
def is_strong_password(password):
    ...
    return True
#Result after checking the password
...
title_lable = customtkinter.CTkLabel(app,text='Passsword Strength Checker',font=title_font,text_color='#FFF',bg_color='#000')
title_lable.place(x=70,y=20)
...
check_button = customtkinter.CTkButton(app,command=display_password_result, text='Check Password', font=button_font,text_color='#FFF',fg_color='#F53905',bg_color='#000',hover_color='#BD3602',cursor='hand2',corner_radius=20,width=50,height=40)
check_button.place(x=105,y=130)

password_strength_lable= customtkinter.CTkLabel(app,text='Your password strength: ',font=title_font,text_color='#FFF',bg_color='#000')
password_strength_lable.place(x=80,y=200)
